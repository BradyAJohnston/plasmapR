...
# Code taken from ggfitttext. (https://github.com/wilkox/ggfittext)
# Ideally the changes required to make this package function properly will
# make it to the main CRAN branch, but until then, the code will be embedded
# directly into this package to help it function properly.
# Credit goes to David Wilkins for the original code, with some modifications
# by me (Brady Johnston) to get the flipping of circular text working.
